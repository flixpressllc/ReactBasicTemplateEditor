...
/***/ function(module, exports, __webpack_require__) {
	...
	window.EditorUserInterface = _Main2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.promiseFlixpress = exports.CheckBox = exports.RadioGroup = exports.clone = undefined;
	...
	var Radio = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            'label',
	            { style: style, className: 'ui radio ' + className },
	...
	var RadioGroup = _react2.default.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        ...
	        var defaultChecked = _props6.defaultChecked;
	        var valueName = _props6.valueName;
	    ...
	    render: function render() {
	        ...
	        var labelName = _props7.labelName;
	        var valueName = _props7.valueName;
	        ...
	        if (children) {
	            _react2.default.Children.map(children, function (node, i) {
	                ...
	                optionNodes.push(_react2.default.createElement(Radio, _extends({
	                    key: i,
	                    checked: itemChecked
	                }, node.props, {
	                    disabled: _this2.props.disabled,
	                    onChange: _this2.toggleChange })));
	            });
	        } else {
	...
	exports.promiseFlixpress = promiseFlixpress;
...
/***/ function(module, exports) {
	...
	var CONTAINING_ELEMENT_ID = 'Template_FlashContent_Div';
	exports.CONTAINING_ELEMENT_ID = CONTAINING_ELEMENT_ID;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _confirmable = __webpack_require__(181);
	
	var _confirmable2 = _interopRequireDefault(_confirmable);
	
	var _createConfirmation = __webpack_require__(182);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClientReactRootIndex = __webpack_require__(192);
	...
	var ReactBrowserComponentMixin = __webpack_require__(200);
	var ReactComponentBrowserEnvironment = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _helperFunctions = __webpack_require__(64);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactConfirm = __webpack_require__(81);
	
	var _unavoidableConstants = __webpack_require__(63);
	...
	_reactModal2.default.setAppElement('#' + _unavoidableConstants.CONTAINING_ELEMENT_ID);
	...
	var Confirmation = function (_React$Component) {
	  ...
	  _createClass(Confirmation, [{
	    ...
	    value: function render() {
	      var _props = this.props;
	      var _props$proceedLabel = _props.proceedLabel;
	      var
	      // title,
	      // modal,
	      proceedLabel = _props$proceedLabel === undefined ? 'OK' : _props$proceedLabel;
	      var _props$cancelLabel = _props.cancelLabel;
	      var cancelLabel = _props$cancelLabel === undefined ? 'Cancel' : _props$cancelLabel;
	      var _props$otherActionLab = _props.otherActionLabel;
	      var otherActionLabel = _props$otherActionLab === undefined ? 'Option 3' : _props$otherActionLab;
	      var otherAction = _props.otherAction;
	      ...
	      var actions = [_react2.default.createElement(
	        'button',
	        { key: 'cancel', type: 'button', className: 'cancel', onClick: cancel },
	        cancelLabel
	      ), _react2.default.createElement(
	        'button',
	        { key: 'confirm', type: 'button', className: 'confirm', onClick: proceed },
	        proceedLabel
	      )];
	      ...
	      if (otherAction) {
	        actions.push(_react2.default.createElement(
	          'button',
	          { key: 'preview', type: 'button', className: 'confirm confirm-preview', onClick: otherAction },
	          otherActionLabel
	        ));
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PreviewImage = __webpack_require__(115);
	
	var _PreviewImage2 = _interopRequireDefault(_PreviewImage);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var EditingUi = _react2.default.createClass({
	  displayName: 'EditingUi',
	  ...
	  handleTextFocus: function handleTextFocus(fieldName) {
	    var img = this.getPreviewImage('TextField', fieldName);
	    this.setState({ lastTextFocus: fieldName, previewImage: img });
	  },
	
	  createTextField: function createTextField(name, object) {
	  ...
	  createDropDown: function createDropDown(name, object) {
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: 'drop-down component input-item', key: 'drop-down-' + safeName },
	      _react2.default.createElement(
	        'label',
	        null,
	        name
	  ...
	  findFirstPreviewImage: function findFirstPreviewImage() {
	    var uiSections = this.props.uiSections;
	    for (var i = 0; i < uiSections.length; i++) {
	      for (var sectionName in uiSections[i]) {
	        var inputArray = uiSections[i][sectionName];
	
	        for (var _i = 0; _i < inputArray.length; _i++) {
	          var image = this.getPreviewImage(inputArray[_i].type, inputArray[_i].name);
	          if (image !== '') {
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      'div',
	      { id: 'editing-ui', className: 'editing-ui component' },
	      sections,
	      _react2.default.createElement(_PreviewImage2.default, { image: this.state.previewImage })
	    );
	  }
	});
	
	exports.default = EditingUi;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _imports = __webpack_require__(21);
	
	var _UserMessages = __webpack_require__(120);
	
	var _UserMessages2 = _interopRequireDefault(_UserMessages);
	
	var _SubmitRender = __webpack_require__(118);
	
	var _SubmitRender2 = _interopRequireDefault(_SubmitRender);
	
	var _ResolutionPicker = __webpack_require__(116);
	
	var _ResolutionPicker2 = _interopRequireDefault(_ResolutionPicker);
	
	var _EditingUi = __webpack_require__(113);
	
	var _EditingUi2 = _interopRequireDefault(_EditingUi);
	
	var _SoundPicker = __webpack_require__(117);
	
	var _SoundPicker2 = _interopRequireDefault(_SoundPicker);
	...
	var EditorUserInterface = _react2.default.createClass({
	  ...
	  handlePlacePreviewOrder: function handlePlacePreviewOrder() {
	    this.setState({ isPreview: true }, function () {
	      this.handlePlaceOrder();
	    });
	  },
	
	  getStartingData: function getStartingData() {
	    _imports.promiseFlixpress.done(function (Flixpress) {
	      var startingPoint = Flixpress.td.getReactStartingData();
	      var currentState = (0, _imports.clone)(this.state);
	      var stateToMerge = (0, _imports.clone)(startingPoint);
	      ...
	      if (startingPoint.nameValuePairs !== undefined) {
	        ...
	        for (var i = dataTypeContainers.length - 1; i >= 0; i--) {
	          if (currentState.hasOwnProperty(dataTypeContainers[i])) {
	            stateToMerge[dataTypeContainers[i]] = (0, _imports.clone)(currentState[dataTypeContainers[i]]);
	  ...
	  // why it didn't pass.
	  checkResult: function checkResult(results) {
	    var messages = [];
	  ...
	  handleFieldsChange: function handleFieldsChange(fieldName, userText) {
	    var fields = this.state.textFields;
	    fields[fieldName].value = userText;
	    this.setState({ textFields: fields });
	  },
	
	  handleDropDownChange: function handleDropDownChange(selectElement, ddName) {
	    var ddState = this.state.dropDowns;
	    ddState[ddName].value = selectElement.value;
	    this.setState({ dropDowns: ddState });
	  },
	
	  handleResolutionIdChange: function handleResolutionIdChange(id) {
	    this.setState({
	      resolutionId: id
	    });
	  },
	
	  handlePreviewChange: function handlePreviewChange(e) {
	    this.setState({
	  ...
	  handlePlaceOrder: function handlePlaceOrder() {
	    ...
	    _imports.promiseFlixpress.done(function (Flixpress) {
	      Flixpress.td.updateXmlForOrder(order).done(function () {
	    ...
	    orderPromise.done(function () {
	      this.setState({ allowSubmit: true }, function () {
	        setTimeout(function () {
	          $('form input[type="submit"]').eq(0).click();
	        }, 100);
	      });
	  ...
	  handleChooseSong: function handleChooseSong(audioInfo) {
	    this.setState({ audioInfo: audioInfo });
	  },
	
	  render: function render() {
	    var resolutionPicker = _react2.default.createElement('span', null);
	    if (this.state.defaultResolutionId !== undefined) {
	      resolutionPicker = _react2.default.createElement(_ResolutionPicker2.default, {
	    ...
	    var editingUi = _react2.default.createElement('span', null);
	    if (this.state.ui !== undefined) {
	      editingUi = _react2.default.createElement(_EditingUi2.default, { uiSections: this.state.ui,
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          null,
	          'Editing Template ',
	          this.props.userSettingsData.templateId
	        )
	      ),
	      _react2.default.createElement(_UserMessages2.default, { messages: this.state.caughtErrors, typeOverride: 'bad' }),
	      _react2.default.createElement(
	        'div',
	        { className: 'main-interaction-area' },
	        _react2.default.createElement(
	          'div',
	          { className: 'column' },
	          editingUi,
	          _react2.default.createElement(_SoundPicker2.default, {
	        ...
	        _react2.default.createElement(
	          ...
	          { className: 'column' },
	          resolutionPicker,
	          _react2.default.createElement(_SubmitRender2.default, {
	...
	exports.default = EditorUserInterface;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var urlPartial = '/templates/images/';
	...
	exports.default = _react2.default.createClass({
	  ...
	  componentWillReceiveProps: function componentWillReceiveProps(newProps) {
	    ...
	    if (newProps.image != this.props.image && newProps.image !== '') {
	      ...
	      var style = (0, _imports.clone)(this.state.style);
	      ...
	      this.currentCheck = $.ajax({
	        ...
	        var xhr = status === 'success' ? obj2 : obj1;
	  ...
	  render: function render() {
	    ...
	    if (this.props.image === '') {
	      return _react2.default.createElement('div', { className: 'preview-image-component component' });
	    }
	    return _react2.default.createElement(
	      'div',
	      { className: 'preview-image-component component' },
	      _react2.default.createElement(
	        'div',
	        { className: (0, _classnames2.default)('preview-image', { 'missing': this.state.missing }), style: (0, _styles.m)({ cursor: 'default' }, this.state.style), onClick: this.openModal },
	        _react2.default.createElement(
	          'span',
	          null,
	          message
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  ...
	  handleResolutionChange: function handleResolutionChange(value) {
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: 'resolution-picker-component component' },
	      _react2.default.createElement(
	        'h3',
	        null,
	        'Resolution Options'
	      ...
	      _react2.default.createElement(_imports.RadioGroup, {
	        options: options,
	        value: checked,
	        valueName: 'id',
	        labelName: 'name',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var STOCK_URL = 'https://fpsound.s3.amazonaws.com/';
	var CUSTOM_URL = 'https://files.flixpress.com/CustomAudio/';
	
	_main.Tabs.setUseDefaultStyles(false);
	
	var SoundPicker = _react2.default.createClass({
	  displayName: 'SoundPicker',
	  ...
	  getPlayerStyle: function getPlayerStyle() {
	  ...
	  audioIsChosen: function audioIsChosen() {
	  ...
	  handleOnAfterOpenModal: function handleOnAfterOpenModal() {
	  ...
	  handleChooseSong: function handleChooseSong(song, type) {
	    var audioInfo;
	    if (song === undefined) {
	  ...
	  handleRemoveAudio: function handleRemoveAudio() {
	    this.props.onChooseSong(this.blankAudioInfo);
	    this.setState({ modalIsOpen: false });
	  },
	
	  stopFrontPlayer: function stopFrontPlayer() {
	  ...
	  handlePlaySong: function handlePlaySong(songType, songId) {
	  ...
	  loadPlayer: function loadPlayer(songUrl) {
	    this.player.pause();
	  ...
	  render: function render() {
	    ...
	    if (this.state.audioOptions !== undefined) {
	      if (this.state.audioOptions.categories !== undefined) {
	        ...
	        var categories = [];
	        var panels = [];
	        for (var key in this.state.audioOptions.categories) {
	          var categorySafeName = key.replace(' ', '-');
	          categories.push(_react2.default.createElement(
	            _main.Tab,
	            { key: 'tab-' + categorySafeName },
	            key
	          ));
	
	          var songs = [];
	          for (var i = 0; i < this.state.audioOptions.categories[key].songs.length; i++) {
	            var song = this.state.audioOptions.categories[key].songs[i];
	            var isPlaying = false;
	            if (this.state.isPlaying && this.state.loadedSong === 'stock-' + song.Id) {
	              isPlaying = true;
	            }
	            songs.push(_react2.default.createElement(Song, { type: 'stock',
	          ...
	          panels.push(_react2.default.createElement(
	            _main.TabPanel,
	            { key: 'tab-panel-' + categorySafeName },
	            songs
	          ));
	        }
	        stockAudioItems.push(_react2.default.createElement(
	          _main.Tabs,
	          { key: 'stock-audio-tabs' },
	          _react2.default.createElement(
	            _main.TabList,
	            null,
	            categories
	      ...
	      if (this.state.audioOptions.customAudio !== undefined) {
	        ...
	        for (var _i = 0; _i < this.state.audioOptions.customAudio.length; _i++) {
	          var _song = this.state.audioOptions.customAudio[_i];
	          var _isPlaying = false;
	          if (this.state.isPlaying && this.loadedSong === 'custom-' + _song.Id) {
	            _isPlaying = true;
	          }
	          customAudioItems.push(_react2.default.createElement(Song, { type: 'custom',
	            key: 'song-custom-' + _song.Id,
	      ...
	      if (stockAudioItems.length > 0) {
	        tabNames.push(_react2.default.createElement(
	          _main.Tab,
	          { key: 'stock-audio-tab' },
	          'Stock Audio'
	        ));
	        tabPanels.push(_react2.default.createElement(
	          _main.TabPanel,
	          { key: 'stock-audio-panel' },
	          _react2.default.createElement(
	            'h2',
	            null,
	            'Stock Audio'
	      ...
	      if (customAudioItems.length > 0) {
	        tabNames.push(_react2.default.createElement(
	          _main.Tab,
	          { key: 'custom-audio-tab' },
	          'Custom Audio'
	        ));
	        tabPanels.push(_react2.default.createElement(
	          _main.TabPanel,
	          { key: 'custom-audio-panel' },
	          _react2.default.createElement(
	            'h2',
	            null,
	            'Custom Audio'
	    ...
	    var removeAudio = this.audioIsChosen() ? _react2.default.createElement(
	      'button',
	      { type: 'button', onClick: this.handleRemoveAudio },
	      'Remove Audio'
	    ) : '';
	
	    return _react2.default.createElement(
	      'div',
	      { className: 'sound-picker-component component' },
	      _react2.default.createElement(
	        'h3',
	        null,
	        'Choose Your Audio'
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'chosen-audio-title' },
	        name
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'chosen-audio-player-wrapper', style: playerStyle },
	        _react2.default.createElement(
	          'audio',
	          { src: url, controls: true, ref: 'frontPlayer' },
	          _react2.default.createElement(
	            'p',
	            null,
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'button',
	          { className: 'cancel', type: 'button', onClick: this.closeModal },
	          'cancel'
	        ),
	        _react2.default.createElement(
	          _main.Tabs,
	...
	var Song = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: (0, _classnames2.default)('song-item', { playing: this.props.isPlaying }) },
	      _react2.default.createElement(
	        'button',
	        { type: 'button', className: 'play-toggle', onClick: this.togglePlay },
	        toggleBtn
	      ),
	      _react2.default.createElement(
	        'button',
	        { type: 'button', onClick: this.choose },
	        'Choose'
	      ),
	      _react2.default.createElement(
	        'span',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AccountBalance = __webpack_require__(111);
	...
	exports.default = _react2.default.createClass({
	  ...
	  confirmOrder: function confirmOrder() {
	    ...
	    if (isChargePerOrder) {
	      ...
	      balanceType = 'minutes';
	      depletionMessage = 'render ' + (0, _helperFunctions.round)(sd.minimumTemplateDuration) + ' ' + balanceType + ' of video';
	      balanceMessage = (0, _helperFunctions.round)(sd.minutesRemainingInContract) + ' ' + balanceType;
	      resultingBalance = (0, _helperFunctions.round)(sd.minutesRemainingInContract - sd.minimumTemplateDuration) + ' ' + balanceType;
	    }
	    ...
	    if (this.props.isPreview !== true) {
	      (0, _confirm2.default)(message, options).then(function () {
	        // proceed
	        _this2.props.placeOrder();
	      }, function () {
	        // cancel
	      });
	    } else {
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: 'submit-render-component component' },
	      _react2.default.createElement(_AccountBalance2.default, { userSettingsData: this.props.userSettingsData, isPreview: this.props.isPreview }),
	      _react2.default.createElement(
	        _imports.CheckBox,
	        { onChange: this.props.onChange, checked: this.props.isPreview },
	        'Preview'
	      ),
	      _react2.default.createElement('input', { name: 'Submit_BT', value: text, type: 'submit', id: 'Submit_BT' })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  ...
	  handleTextEdit: function handleTextEdit(event) {
	    this.props.onUserInput(this.props.fieldName, event.target.value);
	  },
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	      { className: (0, _classnames2.default)(this.props.className, 'text-field', 'component') },
	      _react2.default.createElement(
	        'label',
	...
	exports.default = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    for (var i = 0; i < messagesObjArr.length; i++) {
	      ...
	      messages.push(_react2.default.createElement(Message, { key: i, message: messagesObjArr[i].message, htmlSafe: messagesObjArr[i].htmlSafe, type: type }));
	    }
	
	    if (messages.length !== 0) {
	      return _react2.default.createElement(
	        'div',
	        { className: (0, _classnames2.default)(this.props.className, 'user-messages', 'component') },
	        messages
	      );
	    } else {
	      return _react2.default.createElement('div', { style: this.emptyStyle });
	    }
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsStylesheet = __webpack_require__(170);
	...
	var _childrenPropType = __webpack_require__(123);
	...
	module.exports = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    if (useDefaultStyles) {
	      (0, _jsStylesheet2.default)(__webpack_require__(124));
	    }
	  },
	  componentWillReceiveProps: function componentWillReceiveProps(newProps) {
	  ...
	  isTabNode: function isTabNode(node) {
	    ...
	    var lastAncestor = node;
	    do {
	      if (nodeAncestor === (0, _reactDom.findDOMNode)(this)) {
	        return true;
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  Tabs: __webpack_require__(122),
	  TabList: __webpack_require__(62),
	  Tab: __webpack_require__(61),
	  TabPanel: __webpack_require__(121)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (confirmation) {
	  var options = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
	
	  var obj = { confirmation: confirmation };
	...
	var confirm = (0, _reactConfirm.createConfirmation)(_Confirm2.default);
...
/***/ function(module, exports) {
	...
	module.exports = {
		"79": {
			...
			"dropDowns": {
				"Icon Style": {
					"default": "MyOwnCharacter",
					"options": [
						{
							"name": "My Own Character",
							"value": "MyOwnCharacter",
							"previewImage": "79_MyOwnCharacter.jpg"
						},
						{
							"name": "Android",
							"value": "android",
							"previewImage": "79_android.jpg"
						},
						{
							"name": "Apple",
							"value": "apple",
							"previewImage": "79_apple.jpg"
						},
						{
							"name": "Basketball",
							"value": "basketball",
							"previewImage": "79_basketball.jpg"
						},
						{
							"name": "Broadcast",
							"value": "broadcast",
							"previewImage": "79_broadcast.jpg"
						},
						{
							"name": "Broadcast1",
							"value": "broadcast1",
							"previewImage": "79_broadcast1.jpg"
						},
						{
							"name": "Buicong",
							"value": "buicong",
							"previewImage": "79_buicong.jpg"
						},
						{
							"name": "Bullhorn",
							"value": "bullhorn",
							"previewImage": "79_bullhorn.jpg"
						},
						{
							"name": "Business",
							"value": "business",
							"previewImage": "79_business.jpg"
						},
						{
							"name": "Camera",
							"value": "camera",
							"previewImage": "79_camera.jpg"
						},
						{
							"name": "Car",
							"value": "car",
							"previewImage": "79_car.jpg"
						},
						{
							"name": "Cart",
							"value": "cart",
							"previewImage": "79_cart.jpg"
						},
						{
							"name": "Chart",
							"value": "chart",
							"previewImage": "79_chart.jpg"
						},
						{
							"name": "Clock",
							"value": "clock",
							"previewImage": "79_clock.jpg"
						},
						{
							"name": "Comment",
							"value": "comment",
							"previewImage": "79_comment.jpg"
						},
						{
							"name": "Crosshairs",
							"value": "crosshairs",
							"previewImage": "79_crosshairs.jpg"
						},
						{
							"name": "Crown",
							"value": "crown",
							"previewImage": "79_crown.jpg"
						},
						{
							"name": "Earth",
							"value": "earth",
							"previewImage": "79_earth.jpg"
						},
						{
							"name": "Energy",
							"value": "energy",
							"previewImage": "79_energy.jpg"
						},
						{
							"name": "Eye",
							"value": "eye",
							"previewImage": "79_eye.jpg"
						},
						{
							"name": "Facebook",
							"value": "facebook",
							"previewImage": "79_facebook.jpg"
						},
						{
							"name": "Film",
							"value": "film",
							"previewImage": "79_film.jpg"
						},
						{
							"name": "Fire",
							"value": "fire",
							"previewImage": "79_fire.jpg"
						},
						{
							"name": "Flag",
							"value": "flag",
							"previewImage": "79_flag.jpg"
						},
						{
							"name": "Gauge",
							"value": "gauge",
							"previewImage": "79_gauge.jpg"
						},
						{
							"name": "Gear",
							"value": "gear",
							"previewImage": "79_gear.jpg"
						},
						{
							"name": "Heart",
							"value": "heart",
							"previewImage": "79_heart.jpg"
						},
						{
							"name": "House",
							"value": "house",
							"previewImage": "79_house.jpg"
						},
						{
							"name": "Key",
							"value": "key",
							"previewImage": "79_key.jpg"
						},
						{
							"name": "Legal",
							"value": "legal",
							"previewImage": "79_legal.jpg"
						},
						{
							"name": "Lightbulb",
							"value": "lightbulb",
							"previewImage": "79_lightbulb.jpg"
						},
						{
							"name": "Lock",
							"value": "lock",
							"previewImage": "79_lock.jpg"
						},
						{
							"name": "Magic",
							"value": "magic",
							"previewImage": "79_magic.jpg"
						},
						{
							"name": "Mobile",
							"value": "mobile",
							"previewImage": "79_mobile.jpg"
						},
						{
							"name": "Movie",
							"value": "movie",
							"previewImage": "79_movie.jpg"
						},
						{
							"name": "On Button",
							"value": "onbutton",
							"previewImage": "79_onbutton.jpg"
						},
						{
							"name": "Plane",
							"value": "plane",
							"previewImage": "79_plane.jpg"
						},
						{
							"name": "Rocket",
							"value": "rocket",
							"previewImage": "79_rocket.jpg"
						},
						{
							"name": "Scull & Bones",
							"value": "scullbones",
							"previewImage": "79_scullbones.jpg"
						},
						{
							"name": "Search",
							"value": "search",
							"previewImage": "79_search.jpg"
						},
						{
							"name": "Smiley",
							"value": "smiley",
							"previewImage": "79_smiley.jpg"
						},
						{
							"name": "Speaker",
							"value": "speaker",
							"previewImage": "79_speaker.jpg"
						},
						{
							"name": "Star",
							"value": "star",
							"previewImage": "79_star.jpg"
						},
						{
							"name": "Target",
							"value": "target",
							"previewImage": "79_target.jpg"
						},
						{
							"name": "Thumbs Up",
							"value": "thumbsup",
							"previewImage": "79_thumbsup.jpg"
						},
						{
							"name": "Tools",
							"value": "tools",
							"previewImage": "79_tools.jpg"
						},
						{
							"name": "Twitter",
							"value": "twitter",
							"previewImage": "79_twitter.jpg"
						},
						{
							"name": "Xbox",
							"value": "xbox",
							"previewImage": "79_xbox.jpg"
						},
						{
							"name": "YouTube",
							"value": "youtube",
							"previewImage": "79_youtube.jpg"
						}
					]
				},
				"Background": {
					...
					"options": [
						{
							"name": "Brick",
							"value": "brick",
							"previewImage": "79_brick.jpg"
						},
						{
							"name": "Camo",
							"value": "camo",
							"previewImage": "79_camo.jpg"
						},
						{
							"name": "Concrete",
							"value": "concrete",
							"previewImage": "79_concrete.jpg"
						},
						{
							"name": "Grass",
							"value": "grass",
							"previewImage": "79_grass.jpg"
						},
						{
							"name": "Ground",
							"value": "ground",
							"previewImage": "79_ground.jpg"
						},
						{
							"name": "Ice",
							"value": "ice",
							"previewImage": "79_ice.jpg"
						},
						{
							"name": "Marble",
							"value": "marble",
							"previewImage": "79_marble.jpg"
						},
						{
							"name": "Metal",
							"value": "metal",
							"previewImage": "79_metal.jpg"
						},
						{
							"name": "Paper",
							"value": "paper",
							"previewImage": "79_paper.jpg"
						},
						{
							"name": "Wood",
							"value": "wood",
							"previewImage": "79_wood.jpg"
						}
					]
				},
				"Icon Color": {
					...
					"options": [
						{
							"name": "Black",
							"value": "icon_black",
							"previewImage": "79_icon_black.jpg"
						},
						{
							"name": "Blue",
							"value": "icon_blue",
							"previewImage": "79_icon_blue.jpg"
						},
						{
							"name": "Green",
							"value": "icon_green",
							"previewImage": "79_icon_green.jpg"
						},
						{
							"name": "Orange",
							"value": "icon_orange",
							"previewImage": "79_icon_orange.jpg"
						},
						{
							"name": "Pink",
							"value": "icon_pink",
							"previewImage": "79_icon_pink.jpg"
						},
						{
							"name": "Puprle",
							"value": "icon_puprle",
							"previewImage": "79_icon_puprle.jpg"
						},
						{
							"name": "Red",
							"value": "icon_red",
							"previewImage": "79_icon_red.jpg"
						},
						{
							"name": "Silver",
							"value": "icon_silver",
							"previewImage": "79_icon_silver.jpg"
						},
						{
							"name": "Teal",
							"value": "icon_teal",
							"previewImage": "79_icon_teal.jpg"
						},
						{
							"name": "Yellow",
							"value": "icon_yellow",
							"previewImage": "79_icon_yellow.jpg"
						}
					]
				},
				"Main Text Color": {
					...
					"options": [
						{
							"name": "Black",
							"value": "main_black",
							"previewImage": "79_main_black.jpg"
						},
						{
							"name": "Blue",
							"value": "main_blue",
							"previewImage": "79_main_blue.jpg"
						},
						{
							"name": "Green",
							"value": "main_green",
							"previewImage": "79_main_green.jpg"
						},
						{
							"name": "Orange",
							"value": "main_orange",
							"previewImage": "79_main_orange.jpg"
						},
						{
							"name": "Pink",
							"value": "main_pink",
							"previewImage": "79_main_pink.jpg"
						},
						{
							"name": "Puprle",
							"value": "main_puprle",
							"previewImage": "79_main_puprle.jpg"
						},
						{
							"name": "Red",
							"value": "main_red",
							"previewImage": "79_main_red.jpg"
						},
						{
							"name": "Silver",
							"value": "main_silver",
							"previewImage": "79_main_silver.jpg"
						},
						{
							"name": "Teal",
							"value": "main_teal",
							"previewImage": "79_main_teal.jpg"
						},
						{
							"name": "Yellow",
							"value": "main_yellow",
							"previewImage": "79_main_yellow.jpg"
						}
					]
				},
				"Subtitle Text Color": {
					...
					"options": [
						{
							"name": "Black",
							"value": "sub_black",
							"previewImage": "79_sub_black.jpg"
						},
						{
							"name": "White",
							"value": "sub_white",
							"previewImage": "79_sub_white.jpg"
						},
						{
							"name": "Orange",
							"value": "sub_orange",
							"previewImage": "79_sub_orange.jpg"
						},
						{
							"name": "Teal",
							"value": "sub_teal",
							"previewImage": "79_sub_teal.jpg"
						},
						{
							"name": "Yellow",
							"value": "sub_yellow",
							"previewImage": "79_sub_yellow.jpg"
						}
					]
				}
			},
			"textFields": {
				"Icon Character - type in only one (optional)": {
					"value": "",
					"previewImage": "79_letter.jpg"
				},
				"Text Left of Icon": {
					"value": "",
					"previewImage": "79_letter.jpg"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExecutionEnvironment = __webpack_require__(156);
	var ModalPortal = React.createFactory(__webpack_require__(184));
	var ariaAppHider = __webpack_require__(185);
	var elementClass = __webpack_require__(155);
	var renderSubtreeIntoContainer = __webpack_require__(18).unstable_renderSubtreeIntoContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var findTabbable = __webpack_require__(82);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactIsomorphic = __webpack_require__(214);
	
	var assign = __webpack_require__(3);
	var deprecated = __webpack_require__(236);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../css-loader/index.js!./../postcss-loader/index.js!./reset.css", function() {
				var newContent = require("!!./../css-loader/index.js!./../postcss-loader/index.js!./reset.css");
